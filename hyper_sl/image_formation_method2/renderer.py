...
class PixelRenderer():
    ...
    def render(self, depth, normal, hyp, occ, cam_coord, eval, illum_only=False):
        ...
        sensor_U_distorted, sensor_V_distorted = self.dist.distort_func(X/self.proj_pitch, Y/self.proj_pitch, Z, self.p_list[...,0], self.p_list[...,1])
