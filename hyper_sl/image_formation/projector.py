...
class Projector():
    ...
    def extrinsic_diff(self):
        ...
        # extrinsic_diff[:3,:3] = torch.tensor([[ 0.9999936 , 0. , 0. ],
        #                                     [ 0. , 0.99999183 ,0. ],
        #                                     [ 0. , 0. , 0.9999967  ]])
        ...
        # NEW
        # extrinsic_diff[:3,:3] = torch.tensor([[ 9.9999827e-01 ,-1.7989560e-03 ,-4.4713577e-04 ],
        #                                         [ 1.7980367e-03 , 9.9999630e-01 ,-2.0512582e-03], 
        #                                         [ 4.5081804e-04 , 2.0504522e-03 , 9.9999779e-01 ]])
        ...
        ### NEW NEW
        # extrinsic_diff[:3,:3] = torch.tensor([[ 9.9999630e-01, -2.6491783e-03, -5.4886698e-04],
        #                                     [ 2.6478502e-03 , 9.9999362e-01, -2.3974869e-03],
        #                                     [ 5.5523874e-04 , 2.3960192e-03 , 9.9999696e-01]])
        # # # translate 

        # t_mtrx = torch.tensor([[0.],[0.],[-5.6463715e-02]])        
        
        # extrinsic_diff[:3,:3] = torch.tensor([[ 0.82722795 , 0.10935362,  0.5511223 ],
        #                                     [ 0.11926112 , 0.92435324 ,-0.36241964],
        #                                     [-0.54906356 , 0.36553112 , 0.75160915]])        
        # t_mtrx = torch.tensor([[0.],[0.],[-0.03433177]])       
