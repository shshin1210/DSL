...
def normalization(arg, data):   
    ...
    x_gt_min, x_gt_max = torch.tensor([-0.0021 - 1e-4], device= arg.device), torch.tensor([0.0030 + 1e-4], device= arg.device)
    y_gt_min, y_gt_max = torch.tensor([-0.0026 - 1e-4], device= arg.device), torch.tensor([0.0002 + 1e-4], device= arg.device)
...
def un_normalization(data):
    ...
    x_min, x_max = -0.0021 - 1e-4, 0.0030 + 1e-4
    y_min, y_max = -0.0026 - 1e-4, 0.0002 + 1e-4
