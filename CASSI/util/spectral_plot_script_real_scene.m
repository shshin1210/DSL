...
% data_path = 'Y:\papers\prism\final_result_figures\real_scenes\drink\result_430_680\tmp\';


data_path = 'Y:\papers\prism\final_result_figures\real_scenes\drink\result_430_680\tmp\';
% data_path = 'Y:\papers\prism\scene\20170511_daylight_toys1_with_gt\result_ic1\';
...
first_crop_min_r = 490; first_crop_min_c = 552; first_crop_max_r = 3300; first_crop_max_c = 5790; 

roi_min_r = 900 - first_crop_min_r;    roi_max_r = 3300 - first_crop_min_r;    roi_min_c = 1663 - first_crop_min_c;  roi_max_c = 5110 - first_crop_min_c;
...
crop_width = 4500;%4100;
crop_r_min = 1636; 1740;%1800;
crop_c_min = 5553;
...
%         fprintf('%d\t %f\n', lambdas(j), patch_est(j));
    ...
    plot_table = cat(2, plot_table, patch_est);
