...
% %============================================================================
% % function cassirecon(type, rect, file_name_calib, file_name_main, starti)
% function cassirecon_v2_icchoi( type, rect, file_name_calib, file_name_main, starti )
% % chopping=800 --> create the mini color chart crop at the center
% % We have to crop the edge trim of the coded aperture.
%     nopad = 1; % zero-padding off
%     %nopad = 0; % zero-padding on
...
%     % aperature.
%     chopping = 48; % DEFAULT should be 48
%     cdata = cdata(chopping:size(cdata,1)-chopping,chopping:size(cdata,1)-chopping,:);
...
% %[INCHANG]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %     load vccassi_calib_data.mat
%     %     load vccassi_wave_disp_cf3.mat % from vclab
%     load wave_disp_cf3.mat % hardware calibration data from Duke   
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     % Find blue (right)
%     blue = abs( round( disp_fit( start_wvl ) - disp_fit( laser_wl ) ) );
...
% %[INCHANG]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    if IS_VCCASSI
%          disperse = round( disp_fit( wvls2b ) - disp_fit( laser_wl ) );
%    end
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
%     disp('Done Building data set!');
...
%     else
%         % suspect to be wrong
%         %gp( :, :, i, : ) = circshift( gp_1channels, [ 0, -disperse( i ) , 0 ] );
%         gp( :, :, i, : ) = circshift( gp_1channels, [ 0, disperse( i ) , 0 ] );
%     end
% end
% % Projection
...
%     else
%   % suspect to be wrong
% %         yp( :, :, i, : ) = circshift( yp_1channels, [ 0, disperse( i ), 0 ] );
%         yp( :, :, i, : ) = circshift( yp_1channels, [ 0, -disperse( i ), 0 ] );
%     end
% end
% % Mask
