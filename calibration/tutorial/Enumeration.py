...
# =============================================================================
#
#   Enumeration.hpy shows how to enumerate interfaces and cameras.
...
def query_interface(interface):
    ...
    try:
        ...
        #
        # *** NOTES ***
        # Grabbing node information requires first retrieving(searching) the node and
        ...
        # Node's proper type has to be Casted!!! ex CStringPtr
        node_interface_display_name = PySpin.CStringPtr(nodemap_interface.GetNode('InterfaceDisplayName'))

        # Need to be checked : availability & readability
