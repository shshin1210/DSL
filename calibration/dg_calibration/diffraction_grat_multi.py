...
class PixelRenderer():
    ...
    def __init__(self, arg, opt_param, illum_dir, n_pattern):
        ...
        self.extrinsic_diff = self.ext_diff(self.u, opt_param[2], opt_param[3]).permute(2,3,0,1)
    ...
    def visualization(self, uv_cam, real_uv, n, i):
        ...
        ax.legend(loc = 'best')
        ax.invert_yaxis()
        plt.savefig('./dg_cal/opt/real_and_uv_%03d_patt_%06d_epoch.png' %(n, i))
    ...
    def projection(self, X,Y,Z):
        ...
        X,Y,Z = X.flatten(), Y.flatten(), Z.flatten() # m, wvl, px
